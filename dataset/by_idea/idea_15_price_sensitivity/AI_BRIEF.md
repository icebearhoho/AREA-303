...
## Watch out for
- tiki = VND, retail_sales = USD, shopee_id = IDR
- retail_sales is small (3,400) — elasticity estimates will be noisy
- shopee_id is small (475 products, 3 days) but has real same-product price/discount/sold-volume
  variation day-to-day — a genuine (if short) natural experiment, useful to sanity-check elasticity signs
...
3. Explain with SHAP
4. Cross-check direction of elasticity against shopee_id's day-over-day price vs. monthly_sold_value moves
