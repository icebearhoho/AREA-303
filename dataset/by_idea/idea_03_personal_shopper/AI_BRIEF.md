# AI Brief — Idea #03: Personal Shopper
...
## Goal
Generate personalized product recommendations in Vietnamese via retrieval-augmented generation (RAG).

## Recommended approach
- CLIP + FAISS for retrieval, Gemini 1.5 Pro (LangChain) for generation
...
## Watch out for
- tiki is VN catalog; sephora is English beauty reviews
- Requires a Gemini API key

## Suggested first steps
1. Index the tiki catalog text in FAISS
2. Retrieve top-k for a user query, feed into Gemini to generate VN suggestions
3. Use sephora reviews as preference signal
